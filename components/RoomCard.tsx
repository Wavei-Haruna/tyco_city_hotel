...
export function RoomCard({ room, index = 0, layout = "grid" }: RoomCardProps) {
    ...
    return (
      ...
      >
        ...
        <div className="relative rounded-3xl overflow-hidden">
          ...
          {/* Main Card Container - Horizontal Layout on desktop, vertical on mobile */}
          <motion.div
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
            className="relative backdrop-blur-2xl bg-white/70 border border-white/20 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500 m-[2px] flex flex-col md:flex-row md:h-[280px]"
          >
            {/* Image Container - Left Side */}
            <div className="relative h-56 md:h-auto md:w-[380px] flex-shrink-0 overflow-hidden md:rounded-l-3xl rounded-t-3xl md:rounded-tr-none">
              <motion.div
              ...
              <div className="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-black/40 md:from-transparent via-transparent to-transparent md:to-black/20" />
            ...
            <div className="flex-1 p-6 bg-white/70 flex flex-col justify-between">
              <div>
                {/* Room Name and Price */}
                <div className="flex items-start justify-between mb-3">
                  <motion.h3
                    className="text-2xl font-bold text-tyco-navy line-clamp-1 flex-1"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  <motion.div
                    ...
                    className="backdrop-blur-xl bg-white/90 px-4 py-2 rounded-full shadow-lg border border-white/40 ml-4"
                  >
                    <div className="text-sm  font-bold text-tyco-navy whitespace-nowrap">
                      GH₵{room.price.toLocaleString()}
                      <div className="text-xs font-normal inline-flex text-gray-600">/night</div>
                    </div>
                  </motion.div>
                </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-3xl overflow-hidden h-full">
        ...
        <motion.div
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="relative backdrop-blur-2xl bg-white/70 border border-white/20 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500 m-[2px] flex flex-col h-full"
        >
          {/* Image Container */}
          <div className="relative h-56 overflow-hidden rounded-t-3xl flex-shrink-0">
            ...
            <motion.div
              ...
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.2 + index * 0.1 }}
              className="absolute top-4 right-4 backdrop-blur-2xl badge text-white"
            >
              <div className="text-sm font-header font-bold text-white">
                GH₵{room.price.toLocaleString()}
                <span className="text-xs font-header font-normal text-white">/night</span>
              </div>
            </motion.div>
          ...
          {/* Content Container */}
          <div className="p-6 bg-white/70 flex flex-col flex-1">
            {/* Room Name */}
            <motion.h3
